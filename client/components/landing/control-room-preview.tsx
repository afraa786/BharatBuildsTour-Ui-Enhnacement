    ...
    <section className="py-24 bg-[#F8FAFF]">
      <div className="max-w-[1000px] mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-[32px] md:text-[40px] font-bold text-[#182235] tracking-tight mb-4">
            Know what needs your attention.
          </h2>
          <p className="text-[#667085] text-[18px]">
            The manager sees only what matters. No cluttered dashboards.
          </p>
        </div>

        <div className="bg-white rounded-[2rem] border border-[#E9E2FF] shadow-2xl p-4 md:p-8 relative overflow-hidden">
           {/* Soft glow in the background of the dashboard */}
           <div className="absolute top-0 right-0 w-64 h-64 bg-[#DFF3FF] rounded-full blur-[80px] opacity-50 -z-10 pointer-events-none"></div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-white border border-[#fecaca] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="text-[18px] font-bold text-[#182235] mb-1">MCB32</div>
                <div className="text-[14px] text-[#667085]">8 units remaining</div>
              </div>
              ...
              <div className="bg-white border border-[#fed7aa] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="text-[18px] font-bold text-[#182235] mb-1">3 customers</div>
                <div className="text-[14px] text-[#667085]">₹42,500 outstanding</div>
              </div>
              ...
              <div className="bg-white border border-[#e2e8f0] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="text-[18px] font-bold text-[#182235] mb-1">2 quotes</div>
                <div className="text-[14px] text-[#667085]">Expiring today</div>
              </div>
              ...
              <div className="bg-white border border-[#bfdbfe] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="text-[16px] font-bold text-[#182235] mb-1 leading-snug">MCB32 price revised</div>
                <div className="text-[14px] text-[#667085]">Review new margins</div>
              </div>
              ...
              <div className="bg-white border border-[#d8b4fe] rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow lg:col-span-2">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <div className="text-[18px] font-bold text-[#182235] mb-1">5 follow-ups due</div>
                    <div className="text-[14px] text-[#667085]">Sent quotes without replies in 48h</div>
                  </div>
