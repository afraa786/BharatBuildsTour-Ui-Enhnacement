...
_SYSTEM_PROMPT = (
    ...
    "You have read-only tools to look up real run status, quote details, payment status, invoice "
    ...
    "payments, and today's open quotes. When the admin asks about any of these, call the right "
